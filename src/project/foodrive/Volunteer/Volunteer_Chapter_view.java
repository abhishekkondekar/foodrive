 ...
 * @author abcd
 */
public class Volunteer_Chapter_view extends javax.swing.JPanel {
    ...
    Volunteer_Chapter_view(int area_id,Volunteer_dashboard obj) {
        initComponents();
     ...
     public void load_circle(String searchstr){
         try {
            ...
            while(rs.next()){
                ...
                System.out.println("in chapter view "+rs.getInt("circle_id"));
                
                //Volunteer_chapter_Recordpanel vr=new Volunteer_chapter_Recordpanel(circle_id, area_id, mainFrame);
                records_panel.add(new Volunteer_chapter_Recordpanel(rs.getInt("circle_id"),area_id, mainFrame));
