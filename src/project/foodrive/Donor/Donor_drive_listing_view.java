 ...
 * @author abcd
 */
public class Donor_drive_listing_view extends javax.swing.JPanel {
    ...
    Donor_dashboard mainFrame;
    public Donor_drive_listing_view() {
        initComponents();
   ...
   public Donor_drive_listing_view(int donorid, int area_id,String flag,Donor_dashboard obj) {
        initComponents();
     ...
     public void load_drives(String searchstr){
         try {
            ...
            if (status_flag.equals("Completed")){
                query="SELECT * " +
                            "FROM drive " +
                            "WHERE CONCAT_WS(',',drive_id,status,max_volunteers,start_time,end_time,area_id,vol_select_method) " +
                            "LIKE '%,"+searchstr+"%' " +
            ...
            while(rs.next()){
                ...
                records_panel.add(new Donor_drive_RecordPanel(donor_id, area_id, rs.getInt("drive_id"), this));
