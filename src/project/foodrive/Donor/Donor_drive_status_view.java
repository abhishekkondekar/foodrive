 ...
 * @author abcd
 */
public class Donor_drive_status_view extends javax.swing.JPanel {
    ...
    private Donor_dashboard donor_dashboard;
    
    
    public Donor_drive_status_view() {
        initComponents();
        
    }
    
    public Donor_drive_status_view(int donorid,int areaid,Donor_dashboard obj) {
        initComponents();
        donor_id=donorid;
        area_id=areaid;
        donor_dashboard=obj;
    ...
    private void completed_drive_btnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_completed_drive_btnActionPerformed
        // TODO add your handling code here:
        donor_dashboard.load_in_main_panel(new Donor_drive_listing_view(donor_id,area_id,"Completed",donor_dashboard));
    ...
    private void current_drive_btnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_current_drive_btnActionPerformed
        // TODO add your handling code here:
        donor_dashboard.load_in_main_panel(new Donor_drive_listing_view(donor_id, area_id,"Running", donor_dashboard));
