 ...
 * @author abcd
 */
public class Monitor_first_panel extends javax.swing.JPanel {
    ...
    public Monitor_first_panel() {
        initComponents();
        
    }
    
    public Monitor_first_panel(int monitorid,int areaid,Monitor_dashboard obj) {
        initComponents();
    ...
    private void load_drives()
    {
        try {
            ...
            query="SELECT SUM(food_quantity) AS total_food FROM distribute_to " +
                    "WHERE circle_id in (SELECT circle_id FROM needy_circle WHERE area_id=?);";
            pst=c.prepareStatement(query);
            pst.setInt(1, area_id);
            rs=pst.executeQuery();
            
            if(rs.next()){
                int total_food_served=rs.getInt("total_food");
                served_people_count.setText(""+total_food_served);
                System.out.println(total_food_served);
            }
            
            query="SELECT COUNT(*) AS total_vol FROM volunteer " +
                    "WHERE area_id=?;";
            pst=c.prepareStatement(query);
            pst.setInt(1, area_id);
            rs=pst.executeQuery();
            ...
            if(rs.next()){
                int total_vol=rs.getInt("total_vol");
                volunteers_count.setText(""+total_vol);
                System.out.println(total_vol);
            }
            refresh_count();
    ...
    private void initComponents() {
        ...
        served_people_count = new javax.swing.JLabel();
        jLabel7 = new javax.swing.JLabel();
        jLabel8 = new javax.swing.JLabel();
        volunteers_count = new javax.swing.JLabel();
        ...
        jLabel2.setText("In-progess Drives");

        jLabel3.setFont(new java.awt.Font("Verdana", 0, 18)); // NOI18N
        jLabel3.setText("Drive Conducted");
        ...
        jLabel6.setText("Total Food Served");

        served_people_count.setFont(new java.awt.Font("Verdana", 0, 14)); // NOI18N
        served_people_count.setText("0");

        jLabel7.setFont(new java.awt.Font("Verdana", 0, 14)); // NOI18N
        jLabel7.setText("People(s)");

        jLabel8.setFont(new java.awt.Font("Verdana", 0, 18)); // NOI18N
        jLabel8.setText("Total Volunteers");

        volunteers_count.setFont(new java.awt.Font("Verdana", 0, 14)); // NOI18N
        volunteers_count.setText("0");

        jLabel9.setFont(new java.awt.Font("Verdana", 0, 14)); // NOI18N
        jLabel9.setText("Volunteer(s)");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGap(81, 81, 81)
                .addComponent(served_people_count)
    ...
    private javax.swing.JLabel served_people_count;
    private javax.swing.JLabel volunteers_count;
