 ...
 * @author abcd
 */
public class Volunteer_join_req_view extends javax.swing.JPanel {
    ...
    int monitor_id=-1;
    int area_id=-1;
    public Volunteer_join_req_view() {
        initComponents();
    ...
    public Volunteer_join_req_view(int monitorid,int areaid) {
        initComponents();
    ...
    private void load_req()
    {
        try {
            ...
            while(rs.next()){
                ...
                records_panel.add(new Volunteer_join_RecordPanel(rs.getInt("req_id"),this));
                records_panel.revalidate();
                records_panel.repaint();
                count+=1;
            }
    ...
    private void initComponents() {
        ...
        join_count1 = new javax.swing.JLabel();
        join_count2 = new javax.swing.JLabel();
        join_count3 = new javax.swing.JLabel();
        join_count4 = new javax.swing.JLabel();
        ...
        jLabel1.setText("Volunteer Team Join Request");
        ...
        join_count1.setFont(new java.awt.Font("Verdana", 0, 18)); // NOI18N
        join_count1.setText("ID");

        join_count2.setFont(new java.awt.Font("Verdana", 0, 18)); // NOI18N
        join_count2.setText("Name");

        join_count3.setFont(new java.awt.Font("Verdana", 0, 18)); // NOI18N
        join_count3.setText("Occupation");

        join_count4.setFont(new java.awt.Font("Verdana", 0, 18)); // NOI18N
        join_count4.setText("Age");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(join_count1)
                        .addGap(58, 58, 58)
                        .addComponent(join_count2, javax.swing.GroupLayout.PREFERRED_SIZE, 80, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(182, 182, 182)
                        .addComponent(join_count4, javax.swing.GroupLayout.PREFERRED_SIZE, 50, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
                        .addComponent(join_count3)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        .addComponent(join_count1)
                        .addComponent(join_count2))
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        .addComponent(join_count4)
                        .addComponent(join_count3)))
    ...
    private void tfSearchKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tfSearchKeyTyped
        try {
            ...
            Logger.getLogger(Volunteer_join_req_view.class.getName()).log(Level.SEVERE, null, ex);
        }
...
public void decrementReqCount(){
    ...
    private javax.swing.JLabel join_count1;
    private javax.swing.JLabel join_count2;
    private javax.swing.JLabel join_count3;
    private javax.swing.JLabel join_count4;
