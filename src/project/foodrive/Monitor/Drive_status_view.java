 ...
 * @author abcd
 */
public class Drive_status_view extends javax.swing.JPanel {
    ...
    public Drive_status_view() {
        initComponents();
        
    }
    
    public Drive_status_view(int monitorid,int areaid,Monitor_dashboard obj) {
        initComponents();
    ...
    private void completed_drive_btnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_completed_drive_btnActionPerformed
        // TODO add your handling code here:
        monitor_dashboard.load_in_main_panel(new Drive_listing_view(monitor_id,area_id,"Completed",monitor_dashboard));
    ...
    private void current_drive_btnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_current_drive_btnActionPerformed
        // TODO add your handling code here:
        monitor_dashboard.load_in_main_panel(new Drive_listing_view(monitor_id, area_id,"Running", monitor_dashboard));
