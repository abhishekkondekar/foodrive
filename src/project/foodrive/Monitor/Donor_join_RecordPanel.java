 ...
 * @author abcd
 */
public class Donor_join_RecordPanel extends javax.swing.JPanel {

    /**
     * Creates new form recordPanel
     */
    private int req_id;
    private Donor_join_req_view parent;
    public Donor_join_RecordPanel() {
        initComponents();
    }
    
    public Donor_join_RecordPanel(int reqid,Donor_join_req_view parent) {
        initComponents();
        req_id=reqid;
        this.parent=parent;
        load_req();
    ...
    private void load_req() {
        try {
            ...
            String query="CALL getDonorIdFromReqID(?)";
            ...
            while(rs.next()){
                ...
                this.Id.setText(""+rs.getInt("donor_id"));
                this.fname_text.setText(rs.getString("donor_name"));
                this.lname_text.setText(rs.getString("address_line"));
            }
