 ...
 * @author abcd
 */
public class Monitor_volunteer_view extends javax.swing.JPanel {
    ...
    Monitor_volunteer_view(int monitor_id, int area_id,Monitor_dashboard obj) {
        initComponents();
     ...
     public void load_volunteer(String searchstr){
         try {
            Connection c=null;
            ...
            String query="SELECT m.member_id " +
                        "FROM volunteer v " +
                        "NATURAL JOIN member m " +
                        "WHERE v.area_id=? AND CONCAT_WS(',',m.member_id,m.fname,m.mname,m.lname,m.gender,m.joindate,m.dob,m.email,m.points,m.phone,m.alternate_phone,m.city,m.state,m.country) LIKE '%"+searchstr+"%' " +
                        "LIMIT 100;";
            ...
            while(rs.next()){
                ...
                records_panel.add(new Volunteer_RecordPanel(rs.getInt("member_id"),area_id,mainFrame));
            ...
            c.close();
             ...
             ex.printStackTrace();
             System.out.println("load_volunterr "+ex.getMessage());
        }
     }
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/add_volunteer_pan.png"))); // NOI18N
